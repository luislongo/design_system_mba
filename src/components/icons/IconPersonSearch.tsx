...
export function IconPersonSearch(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <g>
<path d="M10 12C12.21 12 14 10.21 14 8C14 5.79 12.21 4 10 4C7.79 4 6 5.79 6 8C6 10.21 7.79 12 10 12ZM10 6C11.1 6 12 6.9 12 8C12 9.1 11.1 10 10 10C8.9 10 8 9.1 8 8C8 6.9 8.9 6 10 6Z" fill="currentColor"/>
