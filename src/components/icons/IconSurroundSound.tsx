...
export function IconSurroundSound(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
<path d="M8.29 15.71C7.27 14.69 6.75 13.35 6.75 12C6.75 10.65 7.27 9.30999 8.28 8.27999L7.05 7.04999C5.68 8.40999 5 10.21 5 12C5 13.79 5.68 15.59 7.06 16.94L8.29 15.71Z" fill="currentColor"/>
